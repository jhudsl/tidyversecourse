...
`here` is a package specifically designed to help you deal with file organization when you're coding. This package allows you to define in which folder all your relative paths should begin within a project. The path of this folder will be displayed after typing library(here). 
...
Throughout this specialization, we're going to make use of a number of case studies from [opencasestudies](https://github.com/opencasestudies) to demonstrate the concepts introduced in the course. We'll make use of the same case studies throughout the specialization, so that you only have to learn the context - which we'll introduce here - once. This continuity will allow you to focus on the concepts and skills being taught while working with interesting data. Most of these case studies have a public-health question they're being used to answer and all of them use real data. 

### Case Study #1: Health Expenditures

To become familiar with the datasets in this case study, we have to first introduce a bit of information about health care and health policy within the United States. A complicated system, involving federal government- led healthcare policy and private insurance companies, this case study looks at health expenditures, including healthcare coverage and healthcare spending at the State level.
...
The main question fro this case study is: At the state-level, what is the relationship between firearm legislation strength and annual rate of fatal police shootings?
