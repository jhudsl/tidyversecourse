...
Throughout this specialization, we're going to make use of a number of case studies from [opencasestudies](https://opencasestudies.github.io/) to demonstrate the concepts introduced in the course. We'll make use of the same case studies throughout the specialization, so that you only have to learn the context - which we'll introduce here - once. This continuity will allow you to focus on the concepts and skills being taught while working with interesting data. These case studies aim to address a public-health question and all of them use real data. 

### Case Study #1: Health Expenditures

To become familiar with the datasets in this case study, we have to first introduce a bit of information about health care and health policy within the United States. This is a complicated system. Individuals can recieve assistance with health care costs (known as coverage) through goverment-led agencies (such as Medicare and Medicaid) or private insurance companies. This case study looks at health expenditures, including healthcare coverage and healthcare spending at the State level. Understanding more about health expenditures can better inform policy decisions related to health care. 
