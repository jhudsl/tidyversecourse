...
```{r eval = FALSE}
save(introcode_data_object, file = here::here("data", "raw_data", "intro_code_object.R"))
```

Or if we want to load this data:
```{r, eval = FALSE}
load(here::here("data", "raw_data", "intro_code_object.R"))
```
...
We will demonstrate potential ways of organizing a workflow using real data from the [opencasestudies](https://opencasestudies.github.io/) project. 
