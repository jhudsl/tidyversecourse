...
![Data wrangling example](gslides/085.png)
...
![Reshaping data](gslides/088.png)
...
![Longer dataset](gslides/089.png)
...
![gather column names changed](gslides/090.png)
...
![gather specifying which variables to include in long format](gslides/091.png)
...
![Glimpse of msleep dataset](gslides/085.png33)
...
![Filtered to only include Primates](gslides/085.png64)
...
![Numerically filtered dataset](gslides/085.png79)
...
![Data with selected columns](gslides/085.png87)
...
![Data with renamed columns names with `select()`](gslides/085.png94)
...
![Data with renamed columns names using `rename()`](gslides/098.png)
...
![Data with reordered columns names](gslides/099.png)
...
![Data arranged by total sleep in ascending order](gslides/100.png)
...
![Data arranged by total sleep in descending order](gslides/100.png)
...
![Data arranged alphabetically by name](gslides/102.png)
...
![Mutate to add new column to data](gslides/103.png)
...
![Conservation dataset](gslides/104.png)
...
![Output of separate()](gslides/105.png)
...
![Output of unite()](gslides/106.png)
...
![clean_names() output](gslides/108.png)
...
![Data resulting from left_join](gslides/109.png)
...
![group_by() output](gslides/110.png)
...
![Summarize with n()](gslides/111.png)
...
![group_by() and summarize with n()](gslides/112.png)
...
![summarize using mean()](gslides/113.png)
...
![summarize using tabyl() from janitor](gslides/114.png)
...
![summarize numeric variables](gslides/115.png)
...
![summarize entire dataset using skim() from skimr](gslides/116.png)
...
![fct_ output from RStudio](gslides/117.png)
...
![sort sorts variable alphabetically](gslides/118.png)
...
![defining the factor levels sorts this variable sensibly](gslides/119.png)
...
![fct_relevel enables you to change the order of your factor levels](gslides/120.png)
...
![fct_inorder() assigns levels in the same order the level is seen in the data](gslides/121.png)
...
![chickwts dataset](gslides/122.png)
...
![fct_infreq orders levels based on frequency in dataset](gslides/123.png)
...
![fct_rev() reverses the factor level order](gslides/124.png)
...
![fct_reorder allows you to re-level a factor based on a secondary numeric variable](gslides/125.png)
...
![fct_recode() can be used to group multiple levels into a single level and/or to rename levels](gslides/126.png)
...
![converting a numeric type variable to a factor](gslides/127.png)
...
![creating date and date-time objects](gslides/128.png)
...
![mutate() and make_date() create a new column -- departure -- with a date object](gslides/129.png)
...
![mutate() and make_datetime() create a new column -- departure -- with a date-time object](gslides/130.png)
...
![lubridate has specific functions to extract components from date and date-time objects](gslides/131.png)
...
```
## [1] "1016150400s (~32.2 years)"
```


![dates and date-times can be operated upon](gslides/132.png)
...
![`str_length()` output](gslides/134.png)
...
![`str_sub()` output](gslides/136.png)
...
![`str_sub()` output counting from end of string](gslides/137.png)
...
![`str_sort()` output sorts strings](gslides/138.png)
...
<!--html_preserve--><div id="htmlwidget-27466f488c232b9e954a" style="width:960px;height:100%;" class="str_view html-widget"></div>
<script type="application/json" data-for="htmlwidget-27466f488c232b9e954a">{"x":{"html":"<ul>\n  <li>Keisha<\/li>\n  <li><span class='match'>M<\/span>ohammed<\/li>\n  <li>Jane<\/li>\n  <li><span class='match'>M<\/span>athieu<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->


![`str_view()` identifies names that start with M](gslides/139.png)
...
<!--html_preserve--><div id="htmlwidget-034aac42bf45e184b561" style="width:960px;height:100%;" class="str_view html-widget"></div>
<script type="application/json" data-for="htmlwidget-034aac42bf45e184b561">{"x":{"html":"<ul>\n  <li>Keisha<\/li>\n  <li>Mohammed<\/li>\n  <li>Jane<\/li>\n  <li>Mathieu<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->


![`str_view()` does not identify any names that end with M](gslides/140.png)
...
<!--html_preserve--><div id="htmlwidget-cfdec914a4119c8c7880" style="width:960px;height:100%;" class="str_view html-widget"></div>
<script type="application/json" data-for="htmlwidget-cfdec914a4119c8c7880">{"x":{"html":"<ul>\n  <li>Keish<span class='match'>a<\/span><\/li>\n  <li>Mohammed<\/li>\n  <li>Jane<\/li>\n  <li>Mathieu<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->

![`str_view()` identifies names that end with a](gslides/141.png)
...
![`str_view()` does not identify any names that end with A](gslides/142.png)
...
![`str_count()` strings that start with "M"](gslides/143.png)
...
![`str_count()` strings that have an m in them](gslides/144.png)
...
![str_detect() returns TRUE for strings that match the specified pattern; FALSE otherwise](gslides/145.png)
...
![`str_subset()` returns the strings that match the pattern specified](gslides/146.png)
...
![`str_extract()` returns the portions of the strings that match the pattern specified](gslides/133.png2)
...
![`str_replace()` replaces regex with specified characters](gslides/148.png)
...
<!--html_preserve--><div id="htmlwidget-ae1c64f3804ea5392ec0" style="width:960px;height:100%;" class="str_view html-widget"></div>
<script type="application/json" data-for="htmlwidget-ae1c64f3804ea5392ec0">{"x":{"html":"<ul>\n  <li>1234<span class='match'> <\/span>Main<span class='match'> <\/span>Street<\/li>\n  <li>1600<span class='match'> <\/span>Pennsylvania<span class='match'> <\/span>Ave<\/li>\n  <li>Brick<span class='match'> <\/span>Building<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->

![`\s` searches for whitespace](gslides/152.png)
...
<!--html_preserve--><div id="htmlwidget-26f50df43790abf9d35c" style="width:960px;height:100%;" class="str_view html-widget"></div>
<script type="application/json" data-for="htmlwidget-26f50df43790abf9d35c">{"x":{"html":"<ul>\n  <li>1234 Mai<span class='match'>n<\/span> Street<\/li>\n  <li>1600 Pe<span class='match'>nn<\/span>sylva<span class='match'>n<\/span>ia Ave<\/li>\n  <li>Brick Buildi<span class='match'>n<\/span>g<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->

![+ specifies to match the pattern one or more times](gslides/134.png7)
...
<!--html_preserve--><div id="htmlwidget-b1e25f90ab37c19e07d2" style="width:960px;height:100%;" class="str_view html-widget"></div>
<script type="application/json" data-for="htmlwidget-b1e25f90ab37c19e07d2">{"x":{"html":"<ul>\n  <li>1234 Mai<span class='match'>n<\/span> Street<\/li>\n  <li>1600 Pe<span class='match'>n<\/span><span class='match'>n<\/span>sylva<span class='match'>n<\/span>ia Ave<\/li>\n  <li>Brick Buildi<span class='match'>n<\/span>g<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->

![{#} looks to match the pattern exactly the number of times within the curly braces](gslides/155.png)
...
<!--html_preserve--><div id="htmlwidget-d5d13d7c45e4e16fce1c" style="width:960px;height:100%;" class="str_view html-widget"></div>
<script type="application/json" data-for="htmlwidget-d5d13d7c45e4e16fce1c">{"x":{"html":"<ul>\n  <li>1234 Main Street<\/li>\n  <li>1600 Pe<span class='match'>nn<\/span>sylvania Ave<\/li>\n  <li>Brick Building<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->

![{2} specifies that the pattern must be found exactly twice](gslides/156.png)
...
<!--html_preserve--><div id="htmlwidget-a13a7a0fc621416d77b8" style="width:960px;height:100%;" class="str_view html-widget"></div>
<script type="application/json" data-for="htmlwidget-a13a7a0fc621416d77b8">{"x":{"html":"<ul>\n  <li>1234 Main Street<\/li>\n  <li>1600 Pe<span class='match'>nn<\/span>sylvania Ave<\/li>\n  <li>Brick Building<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->

![nn+ searches for double n one or more times in a string](gslides/157.png)
...
<!--html_preserve--><div id="htmlwidget-c22ceb24c51ca370646f" style="width:960px;height:100%;" class="str_view html-widget"></div>
<script type="application/json" data-for="htmlwidget-c22ceb24c51ca370646f">{"x":{"html":"<ul>\n  <li>1234 Main Street<\/li>\n  <li>1600 Pe<span class='match'>nn<\/span>sylvania Ave<\/li>\n  <li>Brick Building<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->
...
<!--html_preserve--><div id="htmlwidget-0e4c768c879eea1c9709" style="width:960px;height:100%;" class="str_view html-widget"></div>
<script type="application/json" data-for="htmlwidget-0e4c768c879eea1c9709">{"x":{"html":"<ul>\n  <li>1234 Main Street<\/li>\n  <li>1600 Pennsylvania Ave<\/li>\n  <li>Brick Building<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->

![{n,m} looks to pattern match between n and m times](gslides/158.png)
...
<img src="03-tidying_files/figure-html/unnamed-chunk-115-1.png" width="672" />
...
<img src="03-tidying_files/figure-html/unnamed-chunk-119-1.png" width="672" />
...
![Dataset on 120 years of Olympics history on athletes and results](gslides/159.png)
...
![Importing data using `read_csv()`](gslides/160.png)

As we learned before, we can use the package `skimr` to take a look at the data. 

![Using the skimr package to have a summary of the data](gslides/161.png)
...
![We have different types of variables in our data](gslides/162.png)
...
![There are some missing values in the data](gslides/163.png)
...
![There is an outlier in the Age variable](gslides/164.png)
...
![Histogram of the variable Age](gslides/165.png)
...
![Boxplot of the variable Age for male and female individuals](gslides/166.png)
...
![Plot of the share of female athletes over time](gslides/167.png)
...
![Creating a variable that shows whether the athlete has a medal or not](gslides/168.png)

And now, we use the following code to create the boxplot.

![Boxplot for the relationship between height and having won a medal](gslides/169.png)
...
![Wrangling Yelp data from JSON into tidy tabular data](gslides/170.png)
...
![`rvest` and `xml2` are helpful for web scraping and working with XML data](gslides/171.png)
