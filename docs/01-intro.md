...
To become familiar with the datasets in this case study, we have to first introduce a bit of information about health care and health policy within the United States. This is a complicated system. Individuals can receive assistance with health care costs (known as coverage) through government-led agencies (such as Medicare and Medicaid) or private insurance companies. This case study looks at health expenditures, including healthcare coverage and healthcare spending at the State level. Understanding more about health expenditures can better inform policy decisions related to health care. 

#### Questions

Ultimately, we'll use the datasets in this case study to answer the following questions:
