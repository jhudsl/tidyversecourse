...
![Survey Google Sheets](gslides/033.png)
...
![Sheet successfully identified](gslides/037.png)
...
![Sheet successfully read into R](gslides/038.png)
...
![Gapminder Dataset in Google Sheets](gslides/039.png)
...
![Where to find the title, key, and URL in Google Sheets](gslides/040.png)
...
![Sheet Successfully Identified](gslides/041.png)
...
![CSV opened in Google Sheets](gslides/046.png)
...
![Download as CSV file](gslides/047.png)
...
![JSON data are hierarchical and nested](gslides/049.png)
...
![XML format relies on nodes, tags, and elements](gslides/052.png)
...
![Relational data are related by unique identifiers](gslides/053.png)
...
![Unique identifiers help link entries across tables](gslides/054.png)
...
![Unique identifiers in relational data avoid ambiguity](gslides/055.png)
...
![output from `dbListTables(db)`](gslides/056.png)
...
![small parts of the `albums` and `artist` tables](gslides/057.png)
...
![inner join output will include any observation found in both tables](gslides/058.png)
...
![inner join includes observations found in both tables](gslides/059.png)
...
![left join will include all observations found in the first table specified](gslides/060.png)
...
![left join will fill in NAs](gslides/061.png)
...
![right join will include all observations found in the last table specified](gslides/062.png)
...
![right join will fill in NAs](gslides/063.png)
...
![full join will include any observation found in either table](gslides/064.png)
...
![full join will fill in NAs](gslides/065.png)
...
![mutating joins summary](gslides/066.png)
...
![Different tags are used to specify different parts of a website](gslides/067.png)
...
![ADD TO CHROME](gslides/068.png)

3. Click "Add extension" 

![Add extension](gslides/069.png)
...
![SelectorGadget icon](gslides/070.png)
...
![SelectorGadget icon on webpage of interest](gslides/071.png)
...
![SelectorGadget selects `strong` on webpage of interest](gslides/072.png)
...
![HTTP access via `httr`](gslides/073.png)
...
![API requests are made to an API endpoint to get an API response](gslides/068.png0)
...
![`httr` code to access GitHub](gslides/069.png4)
...
![`httr` status code and `content()`](gslides/077.png)
...
![output from API request](gslides/078.png)
...
![steak-survey on GitHub](gslides/079.png)
...
![`GET()` steak-survey CSV](gslides/080.png)
...
![Google Maps street view](gslides/081.png)
...
![Data used from Google Maps street view to predict demographics of a neighborhood](gslides/082.png)
...
![Cars in a neighborhood can predict how the area votes](gslides/083.png)
...
![`magick` package's example of adding an image to a plot]![Google Maps street view](gslides/084.png)
...
##   Size: 66.2 kB
## <ON DISK>  /var/folders/xn/fncwm3zs5t36q6chqx1nxktr0000gn/T//RtmpdviqPT/file236474856499.xlsx
```
...
##   Content-Type: application/octet-stream
##   Size: 98.3 kB
## <ON DISK>  /var/folders/xn/fncwm3zs5t36q6chqx1nxktr0000gn/T//RtmpdviqPT/file236421980f48.xls
```
...
##   Content-Type: application/octet-stream
##   Size: 1.57 MB
## <ON DISK>  /var/folders/xn/fncwm3zs5t36q6chqx1nxktr0000gn/T//RtmpdviqPT/file23645e37ee62.xls
```
