...
```{r, echo = FALSE, fig.align="centered", out.width= "900px"}
knitr::include_graphics(here::here("book_figures", "semi_join.png"))
```

Alternatively, `anti_join(artists, albums)` would output the rows of `artists` whose `ArtistId` was *NOT* found in the `albums` table.

```{r, echo = FALSE, fig.align="centered", out.width= "900px"}
knitr::include_graphics(here::here("book_figures", "anti_join.png"))
```
...
knitr::include_graphics(here::here("book_figures", "file_structure.png"))
```
