...
We will likely want to use this data again, so let's save our data to use in later sections of the course. In a data analysis workflow, you would want to potentially save data for futher work.
AVOCADO
```{r}
